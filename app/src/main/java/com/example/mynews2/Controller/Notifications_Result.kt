...
class Notifications_Result: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val myCategories = intent.getIntegerArrayListExtra("nCategories")
        val nCategories = myCategories.toString().replace("[", "").replace("]", "")
            ...
            notificationViewModel =
                NotificationsViewModel(respository = Notifications_Respository())
            ...
            notificationViewModel = ViewModelProvider(this,
                notificationsViewModelFactory).get(NotificationsViewModel::class.java)
            notificationViewModel.mGetNotifications(query = mQuery!!, filterQuery = nCategories)
